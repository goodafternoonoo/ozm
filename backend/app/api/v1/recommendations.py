...
from app.core.response import api_error, api_created, api_success
...
async def get_quiz_recommendations(
    ...
    try:
        ...
        return api_error("퀴즈 추천 생성 실패", error_code=ErrorCode.GENERAL_ERROR)
...
async def get_collaborative_recommendations(
    ...
    try:
        ...
        if not session_id:
            return api_error(
                "session_id is required", error_code=ErrorCode.VALIDATION_ERROR
            )
        ...
        return api_error(
            "협업 필터링 추천 생성 실패", error_code=ErrorCode.GENERAL_ERROR
        )
...
async def get_preference_analysis(
    ...
    try:
        ...
        return api_error("선호도 분석 실패", error_code=ErrorCode.GENERAL_ERROR)
...
async def record_interaction(
    ...
    try:
        ...
        return api_error("상호작용 기록 실패", error_code=ErrorCode.GENERAL_ERROR)
...
async def get_collaborative_recommendations_raw(
    ...
    try:
        ...
        return api_success(recommendations)
    except Exception:
        return api_error(
            "협업 필터링 추천 조회 실패", error_code=ErrorCode.GENERAL_ERROR
        )
...
async def get_cache_statistics(
    ...
    try:
        ...
        return api_error("캐시 통계 조회 실패", error_code=ErrorCode.GENERAL_ERROR)
...
async def invalidate_cache(
    ...
    try:
        ...
        return api_error("캐시 무효화 실패", error_code=ErrorCode.GENERAL_ERROR)
